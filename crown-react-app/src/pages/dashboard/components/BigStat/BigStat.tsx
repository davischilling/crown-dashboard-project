...
export default function BigStat({product, total, color, registrations, bounce}: any) {
  ...
  return (
    ...
    >
      <div className={classes.totalValueContainer}>
        ...
        <BarChart width={150} height={70} data={getRandomData(value)}>
          <Bar
            dataKey="value"
...
function getRandomData(value: string) {
  return Array(7)
    .fill(value)
