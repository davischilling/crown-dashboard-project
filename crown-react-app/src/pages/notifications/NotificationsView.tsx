...
const CloseButton = ({ closeToast, className }: any) => (
  <CloseIcon
    className={className}
    onClick={closeToast}
  />
...
const NotificationsPage: ComponentType<Pick<any, string | number | symbol> & StyledComponentProps<string>> = ({ classes, ...props}: any) => (
  <React.Fragment>
