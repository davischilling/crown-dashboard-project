...
export default function NotificationsPage(props: any) {
  ...
  // local
  var [notificationsPosition, setNotificationPosition]: any = useState(2);
  var [errorToastId, setErrorToastId]: any = useState(null);
  ...
  // #############################################################
  function sendNotification(componentProps: any, options: any) {
    return toast(
      <Notification
        {...componentProps}
  ...
  function handleNotificationCall(notificationType: any) {
    var componentProps;
  ...
  function changeNotificationPosition(positionId: any) {
